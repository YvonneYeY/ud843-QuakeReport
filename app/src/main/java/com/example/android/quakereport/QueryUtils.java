...
//
        ...
        private static String makeHttpRequest(URL url) throws IOException{
            ...
            try{
                ...
                Log.e(LOG_TAG,"Problem retrieving the earthquake JSON resluts.",e);
            }finally {
